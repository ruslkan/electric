...
window.jQuery = jquery__WEBPACK_IMPORTED_MODULE_0___default.a; //window.$ = window.jQuery = $;
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // Slick Slider Header Hero

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#hero').slick({
  slidesToShow: 1,
  dots: true,
  ...
  arrows: false,
  adaptiveHeight: true,
  mobileFirst: true //zIndex: 1

}); // Slick Slider Section Testimonial

jquery__WEBPACK_IMPORTED_MODULE_0___default()('#testimonialCard').slick({
  infinite: true,
  slidesToShow: 2,
  slidesToScroll: 2,
  autoplay: true,
...
var modalContentApartment = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalContentApartment'), {
  showDelay: 450,
  closeOnClick: false
});
var servicesModalContentApartment = new Foundation.Tabs(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#servicesModalContentApartment'), {
  linkClass: 'modal__tabs-title',
  panelClass: 'modal__tabs-panel'
}); // Section Services Modal Content Country House

var modalContentCountryHouse = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalContentCountryHouse'), {
  showDelay: 450,
  closeOnClick: false
});
var servicesModalContentCountryHouse = new Foundation.Tabs(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#servicesModalContentCountryHouse'), {
  linkClass: 'modal__tabs-title',
  panelClass: 'modal__tabs-panel'
}); // Section Services Modal Content Office

var modalContentOffice = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalContentOffice'), {
  showDelay: 450,
  closeOnClick: false
}); // Section Services Modal Content Manufacturing

var modalContentManufacturing = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalContentManufacturing'), {
  showDelay: 450,
  closeOnClick: false
}); // ================================== //
// ===== Modal Photo Gallery
...
var modalPhotoApartment = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoApartment'), {
  closeOnClick: false
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('open.zf.reveal', '#modalPhotoApartment', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.modal').addClass('modal_notscroll');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoGallery', this).slick({
    arrows: true,
    dots: true,
    infinite: true,
    slidesToShow: 1,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoGallery', this).slick('unslick');
}); // Section services modal photo country house

var modalPhotoCountryHouse = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoCountryHouse'), {
  closeOnClick: false
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('open.zf.reveal', '#modalPhotoCountryHouse', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoGallery', this).slick({
    arrows: true,
    dots: true,
    infinite: true,
...
var modalPhotoOffice = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoOffice'), {
  closeOnClick: false
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('open.zf.reveal', '#modalPhotoOffice', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoGallery', this).slick({
    arrows: true,
    dots: true,
    infinite: true,
...
var modalPhotoManufacturing = new Foundation.Reveal(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoManufacturing'), {
  closeOnClick: false
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('open.zf.reveal', '#modalPhotoManufacturing', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#modalPhotoGallery', this).slick({
    arrows: true,
    dots: true,
    infinite: true,
...
module.exports = __webpack_require__(/*! /media/ridik/DEVELOPMENT_HDD2/html/electric/src/assets/js/app.js */"./src/assets/js/app.js");
